package com.qhit.lh.grs.fgf.exam.sjgl.bean;
...
public class Paper implements java.io.Serializable {
	...
	/** full constructor */
	public Paper(String pname, Integer ptime, Integer ptotalScore, Integer csId, Integer qtotal, Integer qscore,
			String ptype, String pstate) {
		this.pname = pname;
		this.ptime = ptime;
